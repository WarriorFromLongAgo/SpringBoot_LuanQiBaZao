 ...
 */
public class OneDEpositPersonalChargeServiceImpl implements ChargeService {
    @Override
    public String getType() {
        return "OneDEpositPersonalChargeServiceImpl=====getType";
    }

    @Override
    public void chargeBackAndReturnResult() {
        System.out.println("OneDEpositPersonalChargeServiceImpl====chargeBackAndReturnResult");
    }
}