package com.xuegao.multi_thread.limit.aspect;
...
public class RateLimitToGuava {
    ...
    @Pointcut(value = "@annotation(com.xuegao.multi_thread.limit.annotation.RateLimit) && execution(public * com.xuegao.multi_thread..*(..)))")
